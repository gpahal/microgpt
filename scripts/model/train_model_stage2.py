...
Command to stage 2 train the pretrained model for 3 epochs. To download the training data from S3, see
`scripts/data/prepare_data_stage2.py`:
...
```sh
uv run python -m scripts.model.combine_model_stage2_runs --runs 1,2,3
```
"""
