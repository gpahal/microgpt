...
def main(
    checkpointing_interval: Annotated[
        ...
        typer.Option(
            ...
            help="The number of iterations between checkpoints. If not provided, it is set to min(1000, max(10, vocab_size // 50))",
            min=1,
        ),
    ] = None,
    ...
    """
    Train a tokenizer. Save the tokenizer to the train/trained_tokenizer directory.
    """
    _run_async(
        train(
            checkpointing_interval=checkpointing_interval,
