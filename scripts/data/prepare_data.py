...
Config used for preparing the data for training a model:
...
```sh
uv run python -m scripts.data.prepare_data
```
"""
...
async def main() -> None:
    ...
    shards_dir_path = os.path.abspath(os.path.join(dirname, "data/shards"))
